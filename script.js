class Keyboard {
  ...
  _createKeys() {
    ...
    if (!Object.keys(this.keysLayout).includes(this.layoutLanguage)) {
      return;
    }

    keyLayout = this.keysLayout[this.layoutLanguage];
...
window.addEventListener('DOMContentLoaded', () => new Keyboard());
